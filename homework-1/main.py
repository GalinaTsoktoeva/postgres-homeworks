...
def connection():
    ...
    fields = [["first_name", "last_name", "title", "birth_date", "notes"], ["customer_id", "company_name", "contact_name"], ["order_id", "customer_id", "employee_id", "order_date", "ship_city"]]
    query = ["INSERT INTO employees VALUES (%s, %s, %s, %s, %s, %s)", "INSERT INTO customers VALUES (%s, %s, %s)", "INSERT INTO orders VALUES (%s, %s, %s, %s, %s)"]
